...
contract Twitter {
    ...
    event tweetcreated(uint256 id, address auuthor, string content, uint256 timestamp);
    event tweetliked(address liker, address tweetauthor, uint256 tweetid, uint256 likkedtweetcount);
    event tweetunliked(address unliker, address tweetauthor, uint256 tweetid, uint256 likkedtweetcount);
